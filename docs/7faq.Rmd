...
Please post an issue on [github](https://github.com/delta-rho/datadr/issues).
...
- datadr provides a backend to scalable detailed visualization of data using [trelliscope](http://deltarho.org/docs-trelliscope/)
