...
Division is achieved through the `divide()` method.  The function documentation is available [here](http://tesseradata.org/docs-datadr/functionref.html#recombine).
...
In this section we cover basic usage of the `recombine()` method.  The function documentation is available [here](http://tesseradata.org/docs-datadr/functionref.html#recombine).
