...
Division is achieved through the `r rdl("divide()")` method.  The function documentation is available [here](http://deltarho.org/docs-datadr/functionref.html#recombine).
...
In this section we cover basic usage of the `r rdl("recombine()")` method.  The function documentation is available [here](http://deltarho.org/docs-datadr/functionref.html#recombine).
